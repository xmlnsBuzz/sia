      ...
      <React.Fragment>
        <section id="Intro2Font">
          ...
          <section id="intro_transformFonts" className="normal-wrap">
            ...
            <div className="normal-wrap">
              <h2 id="intro_fontFace">글꼴의 모양 : font-family</h2>
              ...
              <p className="lead">CSS의 font-style property는 글꼴의 기울기를 다루며, 기울임이 없는 'normal', 기울기와 특유의 글꼴이 있는 'italic', normal체에 경사만 준 'oblique'가 그 값이다.</p>
              <h2 id="intro_fontStretch">글자의 가로폭과 굵기에 따른 분류 : font-stretch</h2>
